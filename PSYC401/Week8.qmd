---
title: 8. Independent study week; data visualisation and making the most of R knowledge
...
The materials for this week are written below. The assignment information is at the bottom of the page

These materials are to support your development in a key skill: data visualization. They are designed to do this by working through real-world examples of how you will often need to process and plot data.

I hope that you use them, and that you find them useful.

I have put a lot of ideas and practical example code into the chapter but you do not need to work through it all. 

-- If you read and use the examples from *just* the introduction and the Quick Start section, that will be helpful to you. 

-- If you want to develop towards professional data visualization skills then work through the examples and then look at the alternate datasets to extend your application of the code.

-- If you are not especially interested in visualization, you can pick up elements of the skills I discuss in the next weeks classes.

Note that this is not designed to "replace" the week 8 session but the materials were constructed as an extra provision of learning opportunities.
...
In the context of the research report exercise, I mention data visualization in relation to stages of the data analysis **pipeline** or **workflow**. But the reality is that, most of the time, visualization is useful and used at every stage of data analysis workflow.
...
```{r}
conc.orth <- read_csv("data/PSYC401_wk8/concurrent.orth_2020-08-11.csv",
...
1.  `conc.orth <- read_csv("data/PSYC401_wk8/concurrent.orth_2020-08-11.csv"` first reads the named `.csv` file, creating an object I will call `conc.orth`: a dataset or tibble we can now work with in R.
...
The assignment can be accessed [here](https://modules.lancaster.ac.uk/mod/quiz/view.php?id=1921466)

The data can be downloaded from [here](data/Wk8 assignment.zip).