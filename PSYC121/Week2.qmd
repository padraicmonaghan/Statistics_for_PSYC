...
Watch Lecture [Part 1](https://modules.lancaster.ac.uk/mod/panopto/view.php?id=1994245)

Watch Lecture [Part 2](https://modules.lancaster.ac.uk/mod/panopto/view.php?id=1994306)

Watch Lecture [Part 3](https://modules.lancaster.ac.uk/mod/panopto/view.php?id=1994308)


Download the lecture slides [here](data/Week_2/week 2 Analysis lecture 2022.pptx)
...
Before the lab, make sure you have worked through the material in the week2 learnr tutorial. [The link is here](https://ma-rconnect.lancs.ac.uk/W2LabPrep/){target="_blank"}

### R Studio tasks

For a reminder of how to start RStudio, [see week 1 lab sheet](Week1.html#task-3---using-rstudio){target="_blank"}
