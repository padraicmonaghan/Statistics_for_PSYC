...
**Histogram non-words** ![](files/week12/hist_nonWords.png)

**QQ-plot non-words** ![](files/week12/qq_nonWords.png)

**Histogram words** ![](files/week12/hist_words.png)

**QQ-plot words** ![](files/week12/qq_words.png)

**Histogram vocabulary** ![](files/week12/hist_vocab.png)

**QQ-plot non-words** ![](files/week12/qq_vocab.png)
...
> **TASK**: Use the code snippet below to clear the environment. **TIP**: If you hover your mouse over the box that includes the code snippet, a 'copy to clipboard' icon will appear in the top right corner of the box. Click that to copy the code. Now you can easily paste it into your script. ![](files/week12/copy.png)
...
5.  What are the variable types for the implicit (IAT_RT) and the explicit (VapingQuestionnaireScore) attitude variables? **Both can be considered continuous variables and at least at interval level.**
...
9.  Do you need to calculate Pearson's r or Spearman's rho? **Pearson's r because the data do meet the assumptions.**
