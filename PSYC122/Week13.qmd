...
1.  What is the regression equation as discussed during the lecture and what does each letter represent? **Y = b0 + b1 \* X + e** **Y = outcome variable** **b0 = intercept** **b1 = slope** **X = predictor variable** **e = error**
