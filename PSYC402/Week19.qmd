---
title: 9. Introduction to Generalized Linear Mixed-effects Models
...
```{r}
#| label: readinallbehind
#| message: false
#| echo: false
long.orth <- read_csv("data/long.orth_2020-08-11.csv", 
                      col_types = cols(
...
You can see, here, that within the `read_csv()` function call, I specify `col_types`, instructing R how to treat a number of different variables. Recall that in [here](Week17.qmd#sec-intro-mixed-data-load), we saw how we can determine how R treats variables at the read-in stage, using `col_types()` specification. You can read more about this [here](https://readr.tidyverse.org/articles/readr.html).
...
gavagai <- read_csv("data/noun-verb-learning-study.csv", na = "-999")
